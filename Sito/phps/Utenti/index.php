<?php 
	...
	sess("db")->start();
	$array= array();
	$query = "SELECT ut_email, ut_nome, ut_cognome, ut_credito FROM utente";
        ...
        <div class="jumbotron">
          <h2>Gestione Utenti</h2>
			...
			<!-- Trigger the modal with a button -->
			  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#aggiungiusr">Aggiungi utenti</button>
			  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#rimuoviusr">Rimuovi utenti</button>
			  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#mcreditousr">Aggiorna credito</button>
